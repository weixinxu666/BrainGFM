...
if __name__ == '__main__':
    ...
    label_path = "/home/xinxu/Lehigh/Codes/Lehigh_graph/xxw_lehigh/data/ADHD200/ADHD200/ADHD200_Phenotypic.csv"
    ...
    label_id = labels["Participant ID"]
    label_dx = labels["DX"]
    id_dx_dict = {}
    ...
    id_conn_dict = {"id": id_mat, "conn": conn_mat, 'adhd': label_dx_mat}

    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/id_adhd200.npy', id_mat)
    np.save('/home/xinxu/Lehigh/Codes/BICLab_data/downstream/label_dict_adhd200.npy', id_conn_dict)
