...
if __name__ == '__main__':
    ...
    ptsd_path = '/home/xinxu/Lehigh/Codes/BICLab_data/data/conn_aurora.npy'

    aurora = np.load(ptsd_path, allow_pickle=True)
    aurora_label = [1] * aurora.shape[0]
    ...
    aurora_label_mat = np.array(aurora_label)

    conn_mat = np.concatenate((conn_mat, aurora), axis=0)
    label_mat = np.concatenate((label_mat, aurora_label_mat), axis=0)
    ...
    np.save('/home/xinxu/Lehigh/Codes/BICLab_data/downstream/label_dict_hbn_aurora.npy', id_conn_dict)
