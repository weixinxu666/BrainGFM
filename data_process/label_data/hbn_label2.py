...
def get_fmri_data(file_dir):
    ...
    # embarc_sex_labels = '/home/xinxu/Lehigh/Codes/lehigh_eeg/EEG-Conformer-main/Data/HBN/hbn_adj_labels_2024.npy'
    # embarc_sex_labels = '/home/xinxu/Lehigh/Codes/lehigh_eeg/EEG-Conformer-main/Data/HBN/hbn_eus_labels_2024.npy'
    # embarc_sex_labels = '/home/xinxu/Lehigh/Codes/lehigh_eeg/EEG-Conformer-main/Data/HBN/hbn_md_labels_2024.npy'
    # embarc_sex_labels = '/home/xinxu/Lehigh/Codes/lehigh_eeg/EEG-Conformer-main/Data/HBN/hbn_ptsd_labels_2024.npy'
    # embarc_sex_labels = '/home/xinxu/Lehigh/Codes/lehigh_eeg/EEG-Conformer-main/Data/HBN/hbn_ecp_labels_2024.npy'
    # embarc_sex_labels = '/home/xinxu/Lehigh/Codes/lehigh_eeg/EEG-Conformer-main/Data/HBN/hbn_tou_labels_2024.npy'
    # embarc_sex_labels = '/home/xinxu/Lehigh/Codes/lehigh_eeg/EEG-Conformer-main/Data/HBN/hbn_dys_labels_2024.npy'
    # embarc_sex_labels = '/home/xinxu/Lehigh/Codes/lehigh_eeg/EEG-Conformer-main/Data/HBN/hbn_ptd_labels_2024.npy'
    # embarc_sex_labels = '/home/xinxu/Lehigh/Codes/lehigh_eeg/EEG-Conformer-main/Data/HBN/hbn_psd_labels_2024.npy'
...
if __name__ == '__main__':
    ...
    id_conn_dict = {"id": id_mat, "conn": conn_mat, 'hbn_mdd': label_mat}
    ...
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/downstream/label_dict_hbn_adj.npy', id_conn_dict)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/downstream/label_dict_hbn_eus.npy', id_conn_dict)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/downstream/label_dict_hbn_md.npy', id_conn_dict)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/downstream/label_dict_hbn_ptsd.npy', id_conn_dict)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/downstream/label_dict_hbn_ecp.npy', id_conn_dict)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/downstream/label_dict_hbn_tou.npy', id_conn_dict)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/downstream/label_dict_hbn_dys.npy', id_conn_dict)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/downstream/label_dict_hbn_ptd.npy', id_conn_dict)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/downstream/label_dict_hbn_psd.npy', id_conn_dict)
