...
def get_fmri_data(file_dir):
    ...
    for name in tqdm(name_list):
        ...
        if name.endswith("Schaefer100_Alex_zhao.csv"):
        # if name.endswith("AAL116_Alex_zhao.csv"):
        # if name.endswith("yeo2011_Alex_zhao.csv"):
            id_indiv = name.split('S')[-1].split('_')[0]
...
if __name__ == '__main__':
    file_dir = '/home/xinxu/Lehigh/Codes/BICLab_data/ADNI/ADNI_3/ROISignals_AROMA'
    ...
    np.save('/home/xinxu/Lehigh/Codes/BICLab_data/downstream/label_dict_adni3_sf100.npy', id_conn_dict)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/downstream/label_dict_adni3_yeo.npy', id_conn_dict)
