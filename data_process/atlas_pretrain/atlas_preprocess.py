...
def get_fmri_data_by_atlas(file_dir):
    ...
    for atlas_name, matrices in atlas_data.items():
        ...
        if matrices:
            ...
            # save_path = f'/home/xinxu/Lehigh/Codes/BICLab_data/data/conn_adni3_{atlas_name}.npy'
            # save_path = f'/home/xinxu/Lehigh/Codes/BICLab_data/data/conn_nyu_cud_{atlas_name}.npy'
            # save_path = f'/home/xinxu/Lehigh/Codes/BICLab_data/data/conn_ucla_cnp_{atlas_name}.npy'
            # save_path = f'/home/xinxu/Lehigh/Codes/BICLab_data/data/conn_cam_can_{atlas_name}.npy'
            # save_path = f'/home/xinxu/Lehigh/Codes/BICLab_data/data/conn_pre_ad_{atlas_name}.npy'
            # save_path = f'/home/xinxu/Lehigh/Codes/BICLab_data/data/conn_aomic_{atlas_name}.npy'
            # save_path = f'/home/xinxu/Lehigh/Codes/BICLab_data/data/conn_submex_{atlas_name}.npy'
            save_path = f'/home/xinxu/Lehigh/Codes/BICLab_data/data/conn_submex_rtms_{atlas_name}.npy'
...
if __name__ == '__main__':
    ...
    # file_dir = '/home/xinxu/Lehigh/Codes/BICLab_data/NYU_CUD/ROISignals'
    # file_dir = '/home/xinxu/Lehigh/Codes/BICLab_data/UCLA_CNP/ROISignals'
    # file_dir = '/home/xinxu/Lehigh/Codes/BICLab_data/Cam_CAN/Cam_CAN_rsfMRI_ROISignals'
    # file_dir = '/home/xinxu/Lehigh/Codes/BICLab_data/PREVENT-AD/ROISignals'
    # file_dir = '/home/xinxu/Lehigh/Codes/BICLab_data/AOMIC/AOMIC-PIOP1/ROISignals'
    file_dir = '/home/xinxu/Lehigh/Codes/BICLab_data/SubstanceUseDisorder_Mexico_Cocaine_rTMS/ROISignals'
