...
def get_fmri_data_by_atlas(file_dir):
    ...
    for atlas_name, matrices in atlas_data.items():
        ...
        if matrices:
            ...
            save_path = f'/home/xinxu/Lehigh/Codes/BICLab_data/data/conn_hcp_{atlas_name}.npy'
...
if __name__ == '__main__':
    file_dir = '/home/xinxu/Lehigh/Codes/BICLab_data/HCP/HCP_aging/rsfMRI_ROISignals_Schaefer100'
