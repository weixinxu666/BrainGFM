...
def xlsx_to_csv_pd():
    ...
    data_xls = pd.read_excel('/home/xinxu/Lehigh/Codes/BICLab_data/SubstanceUseDisorder_Mexico_Cocaine_rsfMRI/participants.xlsx', index_col=0)
    data_xls.to_csv('/home/xinxu/Lehigh/Codes/BICLab_data/SubstanceUseDisorder_Mexico_Cocaine_rsfMRI/participants.csv', encoding='utf-8')
