...
def get_fmri_data(file_dir):
    ...
    for name in tqdm(name_list):
        ...
        #     for file in files:
        # if name.endswith("schaefer100_subcortex_Alex_zhao.csv"):
        if name.endswith("AAL3V1_Alex_zhao.csv"):
            id_indiv = name.split('_')[0] + '_' + name.split('_')[2]
            csv_path = os.path.join(file_dir, name)
...
if __name__ == '__main__':
    file_dir = '/home/xinxu/Lehigh/Codes/BICLab_data/HABS/ROISignals_AROMA'
    ...
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/id_habs.npy', id_mat)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/conn_habs.npy', conn_mat)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/dict_habs.npy', id_conn_dict)

    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/aug_conn_habs.npy', conn_mat)
