...
def get_fmri_data(file_dir):
    ...
    for name in tqdm(name_list):
        ...
        for root, dirs, files in os.walk(dir_path):
            for file in files:
                if file.endswith("Schaefer100_plus.csv"):
                    sub_name = name.split('_')[0] + '_' + name.split('_')[1]
...
if __name__ == '__main__':
    ...
    # np.save('/home/xinxu/Lehigh/Codes/lehigh_fmri/gpt_fmri/data/id_prev_ad.npy', id_mat)
    # np.save('/home/xinxu/Lehigh/Codes/lehigh_fmri/gpt_fmri/data/conn_prev_ad.npy', conn_mat)
    # np.save('/home/xinxu/Lehigh/Codes/lehigh_fmri/gpt_fmri/data/dict_prev_ad.npy', id_conn_dict)

    np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/aug_conn_prev_ad.npy', conn_mat)
