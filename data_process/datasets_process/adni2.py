            ...
            for file in files:
                ...
                if file.endswith("AAL116.csv"):
                    ...
                    for slice_i in roi_ts_slice:
                        ...
                        conn = get_correlation_matrices(slice_i, thres=0.5)
...
if __name__ == '__main__':
    ...
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/id_adni2.npy', id_mat)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/conn_adni2.npy', conn_mat)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/dict_adni2.npy', id_conn_dict)

    np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/aug_conn_adni2.npy', conn_mat)
