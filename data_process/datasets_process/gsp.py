...
def get_fmri_data(file_dir):
    ...
    for name in tqdm(name_list):
        ...
        for root, dirs, files in os.walk(dir_path):
            for file in files:
                if file.endswith("Schaefer100_plusSubcort.csv"):
...
if __name__ == '__main__':
    file_dir = '/home/xinxu/Lehigh/Codes/BICLab_data/BrainGenomicsSuperstructProject(GSP)_Harvard/GSP_fMRI/ROISignals_AROMA'
    ...
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/id_gsp.npy', id_mat)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/conn_gsp.npy', conn_mat)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/dict_gsp.npy', id_conn_dict)

    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/aug_conn_gsp.npy', conn_mat)
