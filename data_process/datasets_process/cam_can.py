...
if __name__ == '__main__':
    ...
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/id_cam_can.npy', id_mat)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/conn_cam_can.npy', conn_mat)
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/dict_cam_can.npy', id_conn_dict)

    np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/aug_conn_cam_can.npy', conn_mat)
