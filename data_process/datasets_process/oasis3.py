...
if __name__ == '__main__':
    ...
    # np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/aug_conn_oasis3_sf200.npy', conn_mat)
    np.save('/home/xinxu/Lehigh/Codes/BICLab_data/data/conn_oasis3_sf200.npy', conn_mat)
